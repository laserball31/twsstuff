...
case "exotic_shop":
	{
		_return = [
			...
			["cl3_carrera_gt_lavender",500000],
			...
			["cl3_murcielago_lavender",300000],
			["IVORY_REV",550000],
			...
			["cl3_arielatom_race_aqua",100000], 
			["cl3_arielatom_race_black",100000], 
			["cl3_arielatom_race_blue",100000], 
			["cl3_arielatom_race_camo",100000], 
			["cl3_arielatom_race_camo_urban",100000], 
			["cl3_arielatom_race_gold",100000], 
			["cl3_arielatom_race_green",100000], 
			["cl3_arielatom_race_lime",100000], 
			["cl3_arielatom_race_red",100000], 
			["cl3_arielatom_race_purple",100000], 
			["cl3_arielatom_race_silver",100000], 
			["cl3_arielatom_race_white",100000],
			["A3L_Atom",300000],
			["A3L_Flipcar",300000],			
			["cl3_veyron_red_red",1100000],
			["cl3_veyron_lblue_dblue",1100000],
			["cl3_veyron_lblue_lblue",1100000]
		];
	};
	...
	case "donator_car":
	{
		if(license_civ_donator && playerSide == civilian) then
		{
			...
			_return set[count _return,["cl3_murcielago_lavender",300000]];
			...
			_return set[count _return,["cl3_z4_2008_lavender",300000]];
			...
			_return set[count _return,["cl3_458_lavender",300000]];
			...
			_return set[count _return,["cl3_carrera_gt_lavender",500000]];
			...
			_return set[count _return,["cl3_carrera_gt_yellow",500000]];
			...
			_return set[count _return,["cl3_golf_mk2_lavender",10000]];
			...
			_return set[count _return,["cl3_civic_vti_lavender",40000]];
