...
if(!((player distance (getMarkerPos "police_hq_1") < 60) 
OR  (player distance (getMarkerPos "police_hq_2") < 60) 
OR (player distance (getMarkerPos "cop_spawn_3") < 60) 
OR (player distance (getMarkerPos "cop_spawn_6") < 60) 
OR (player distance (getMarkerPos "cop_spawn_4") < 60) 
OR (player distance (getMarkerPos "cop_spawn_5") < 60)
OR (player distance (getMarkerPos "checkpoint_jail_1") < 60) 
OR (player distance (getMarkerPos "checkpoint_jail_2") < 60) 
OR (player distance (getMarkerPos "checkpoint_jail_3") < 60) 
OR (player distance (getMarkerPos "checkpoint_jail_4") < 60) 
OR (player distance (getMarkerPos "checkpoint_jail_5") < 60)
OR (player distance (getMarkerPos "checkpoint_jail_6") < 60)
OR (player distance (getMarkerPos "jail_at_jail") < 60))) then 
{
