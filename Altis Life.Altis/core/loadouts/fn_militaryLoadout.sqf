...
if(__GETC__(life_coplevel) < 5) exitWith {hint"You are not Military";};
...
titleText ["That'll be $200,000. Now, please undress...","PLAIN"];
...
player addMagazine "16Rnd_9x21_Mag";
player addMagazine "16Rnd_9x21_Mag";
player addMagazine "150Rnd_762x51_Box_Tracer";
player addMagazine "150Rnd_762x51_Box_Tracer";
player addMagazine "150Rnd_762x51_Box_Tracer";
player addMagazine "150Rnd_762x51_Box_Tracer";
player addMagazine "150Rnd_762x51_Box_Tracer";
