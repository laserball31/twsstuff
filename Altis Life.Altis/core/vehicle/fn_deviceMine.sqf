...
_item = switch(true) do {
	...
	case (_zone in ["heroin_1","heroin_2","heroin_3","heroin_4","heroin_5","heroin_6"]): {"heroinu"};
	case (_zone in ["cocaine_1","cocaine_2","cocaine_3","cocaine_4","cocaine_5","cocaine_6"]): {"cocaine"};
	case (_zone in ["meth_1","meth_2","meth_3","meth_4","meth_5","meth_6"]): {"methu"};
	case (_zone in ["weed_1","weed_2","weed_3","weed_4","weed_5","weed_6"]): {"cannabis"};
