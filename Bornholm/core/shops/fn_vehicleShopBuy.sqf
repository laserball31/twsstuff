...
if(!([_className] call life_fnc_vehShopLicenses) && _className != "B_MRAP_01_hmg_F" && _className != "B_MRAP_01_gmg_F") exitWith {hint localize "STR_Shop_Veh_NoLicense"};
...
if(_mode) then {
	if(!(_className in ["B_MRAP_01_gmg_F","B_MRAP_01_hmg_F"])) then {
