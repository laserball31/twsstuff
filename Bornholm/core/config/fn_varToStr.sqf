...
switch (_var) do
{
	...
	case "life_inv_uranium": {(localize "STR_Item_Uranium")};
	case "life_inv_euranium": {(localize "STR_Item_Euranium")};
	case "life_inv_hazmat_gloves": {(localize "STR_Item_HazmatG")};
	case "life_inv_battery": {(localize "STR_Item_CellP")};
	...
	case "license_civ_grapes": {(localize "STR_License_Grapes")};
	...
	case "license_civ_opfor": {"ISIS Sticker"};
};
