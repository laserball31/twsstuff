...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Kart = ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F"];
	...
	IL_Supported_Cargo_Veh_Offroad = IL_Supported_Quadbike + IL_Supported_Kart;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_OFFROAD + IL_Supported_Kart;
