...
switch (_var) do
{
	...
	case "life_inv_puranium": {"Uranium Solvent"}; // Add This
    case "life_inv_ipuranium": {"Illegal Uranium"}; // Add This
    ...
    case "life_inv_uranium": {"Refined Uranium"}; // Add This
	...
	case "license_civ_bounty": {"Bounty Hunter's Licence"};
