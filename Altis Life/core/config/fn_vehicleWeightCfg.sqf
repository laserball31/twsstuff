...
switch (_className) do
{
	...
	case "O_Truck_03_fuel_F": {250};
	case "Land_CargoBox_V1_F": {5000};
	case "Box_IND_Grenades_F": {350};
	case "B_supplyCrate_F": {700};
	case "I_Heli_light_03_unarmed_F": {250};
	case "O_G_Offroad_01_armed_F": {25};
	case "B_MRAP_01_hmg_F": {50};
	case "B_MRAP_01_gmg_F": {50};
	case "B_Heli_Transport_01_F": {300};
	case "B_Heli_Attack_01_F": {100};
	case "B_SDV_01_F": {350};
	case "C_Quadbike_01_F": {25};
	case "B_G_Van_01_transport_F": {300};
	case "O_Truck_03_repair_F": {250};
	case "O_Heli_Attack_02_F": {50};
