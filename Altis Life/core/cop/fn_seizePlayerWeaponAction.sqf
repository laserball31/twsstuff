...
if(count _itemArray == 0) exitWith {
	[[52, player, format["%1 did not have a weapon!", name cursorTarget]],"TON_fnc_logIt",false,false] spawn life_fnc_MP;
};
...
titleText["Your weapons and mags have been seized!.","PLAIN"];