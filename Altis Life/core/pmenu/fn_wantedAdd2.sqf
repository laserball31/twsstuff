...
{
    _side = switch(side _x) do {case west: {"Cop"}; case independent: {"Medic"}; case civilian : {"Civ"}; default {"Unknown"};};
...
_text = "Speeding inside town";
_data = "465";
_list2 lbAdd format["%1 (%2)",_text,_data];
_list2 lbSetData [(lbSize _list2)-1,_data];

_text = "Speeding outside town";
_data = "465A";
_list2 lbAdd format["%1 (%2)",_text,_data];
_list2 lbSetData [(lbSize _list2)-1,_data];

_text = "Accessory Jail Escape";
_data = "901A";
_list2 lbAdd format["%1 (%2)",_text,_data];
_list2 lbSetData [(lbSize _list2)-1,_data];

_text = "Use of illegal explosives";
_data = "213";
_list2 lbAdd format["%1 (%2)",_text,_data];
_list2 lbSetData [(lbSize _list2)-1,_data];
...
_text = "Evading checkpoint";
_data = "462A";
_list2 lbAdd format["%1 (%2)",_text,_data];
_list2 lbSetData [(lbSize _list2)-1,_data];

_text = "Evading police";
_data = "462";
_list2 lbAdd format["%1 (%2)",_text,_data];
_list2 lbSetData [(lbSize _list2)-1,_data];
